...
foreach ($data as $supportWeek)
{
    ...
    if((trim($supportTeam->getDeveloper1()) != trim($supportWeek[1]))&&($supportWeek[1]!="** Developer Required **")){ //If there is a difference then create an audit message (change has been made)
    ...
    if((trim($supportTeam->getDeveloper2()) != trim($supportWeek[2]))&&($supportWeek[2]!="** Developer Required **")) //checking second developer in support team
    {
